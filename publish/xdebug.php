...
return [
    ...
    'xdebug' => [
        'client_host' => env('XDEBUG_CLIENT_HOST', '127.0.0.1'), // IDE 所在机器的 IP
        // 如果 Hyperf 运行在 Docker 或虚拟机内，需设置为宿主机的 IP
        // 例如 Docker 内可设置为 'host.docker.internal'
        // 例如 WSL 内可设置为宿主机对应 vEthernet (WSL) 的 IPv4 地址
        'client_port' => (int)env('XDEBUG_CLIENT_PORT', 9000), // PhpStorm 监听的调试端口
        'mode' => 'debug',
    ],
